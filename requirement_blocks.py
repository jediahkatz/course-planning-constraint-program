...
CIS_BSE: RequirementBlock = [
    ...
    *([Requirement.base(categories=['MATH@SEAS'])] * 2),
    # === NATURAL SCIENCE ===
    ...
    *([Requirement.base(categories=['ENG@SEAS'])] * 2),
    *([Requirement.base(categories=['ENG@SEAS', 'MATH@SEAS', 'NATSCI@SEAS'])] * 4),
    # === GENERAL ELECTIVES ===
    Requirement.base(courses=['EAS-203']),
    *([Requirement.base(categories=['SS@SEAS', 'H@SEAS'])] * 4),
    *([Requirement.base(categories=['SS@SEAS', 'H@SEAS', 'TBS@SEAS'])] * 2),
    # === FREE ELECTIVES ===
...
MATH_MINOR: RequirementBlock = [
    ...
    *([Requirement.base(depts=['MATH'], min_number=202)] * 2)
]
